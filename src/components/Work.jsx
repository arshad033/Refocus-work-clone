...
function Work() {
  ...
  return (
    <div className="flex flex-col items-center text-white relative mt-12">
      {img.map((item, index) => (
        <img
          style={{
            top: `${item.top}%`,
      ...
      <h1 className="text-[30rem] font-semibold pt-0 relative bottom-10 select-none">
        Work
      </h1>
      <h1 className="absolute bottom-28 text-gray-400 text-xl">
